...
def main():
############### load dataset ######################
    path1 = '/home/iichsk/workspace/vrep6_lstm_classify/database/vrep6_noraml.csv'
    dataX1, data_label_Y1 = lp.load_data3(path1, seq_len)
    print('data1 load')
    path2 = '/home/iichsk/workspace/vrep6_lstm_classify/database/vrep6_joint1error.csv'
    dataX2, data_label_Y2 = lp.load_data3(path2, seq_len)
    print('data2 load')
    path3 = '/home/iichsk/workspace/vrep6_lstm_classify/database/vrep6_joint2error.csv'
    dataX3, data_label_Y3 = lp.load_data3(path3, seq_len)
    print('data3 load')
    path4 = '/home/iichsk/workspace/vrep6_lstm_classify/database/vrep6_joint3error.csv'
    dataX4, data_label_Y4 = lp.load_data3(path4, seq_len)
    print('data4 load')
    path5 = '/home/iichsk/workspace/vrep6_lstm_classify/database/vrep6_joint4error.csv'
    dataX5, data_label_Y5 = lp.load_data3(path5, seq_len)
    print('data5 load')
    path6 = '/home/iichsk/workspace/vrep6_lstm_classify/database/vrep6_joint5error.csv'
    dataX6, data_label_Y6 = lp.load_data3(path6, seq_len)
    print('data6 load')
    path7 = '/home/iichsk/workspace/vrep6_lstm_classify/database/vrep6_joint6error.csv'
    dataX7, data_label_Y7 = lp.load_data3(path7, seq_len)
    print('data7 load')
    dataX = np.concatenate((dataX1,dataX2,dataX3,dataX4,dataX5,dataX6,dataX7), axis=0)
    data_label_Y = np.concatenate((data_label_Y1,data_label_Y2,data_label_Y3,data_label_Y4,data_label_Y5,data_label_Y6,data_label_Y7), axis=0)
    trainX, testX, train_label, test_label = lp.dataset_split(dataX, data_label_Y)
...
########################## test ###########################
    ...
    #print("target=",target)
    c_names = ['normal', 'errorjoint1','errorjoint2', 'errorjoint3','errorjoint4','errorjoint5','errorjoint6']
