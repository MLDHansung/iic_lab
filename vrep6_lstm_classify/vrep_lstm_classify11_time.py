...
############### load dataset ######################
    ...
    # dataX1, data_label_Y1 = lp.load_data2(path1, seq_len)
    # print('data1 load')
    ...
    dataX3, data_label_Y3 = lp.load_data2(path3, seq_len)
    print('data3 load')
    path4 = '/home/iichsk/workspace/vrep6_lstm_classify/database/joint3error.csv'
    dataX4, data_label_Y4 = lp.load_data2(path4, seq_len)
    print('data4 load')
    path5 = '/home/iichsk/workspace/vrep6_lstm_classify/database/joint4error.csv'
    dataX5, data_label_Y5 = lp.load_data2(path5, seq_len)
    print('data5 load')
    #path6 = '/home/iichsk/workspace/vrep6_lstm_classify/database/joint5error.csv'
    #dataX6, data_label_Y6 = lp.load_data2(path6, seq_len)
    #print('data6 load')
    
    dataX = np.concatenate((dataX3,dataX4,dataX5), axis=0)
    data_label_Y = np.concatenate((data_label_Y3,data_label_Y4,data_label_Y5), axis=0)
...
########################## test ###########################
    ...
    #print("target=",target)
    c_names = ['errorjoint2', 'errorjoint3','errorjoint4']
