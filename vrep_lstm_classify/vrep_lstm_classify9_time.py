...
seq = torch.load("/home/iichsk/workspace/vrep_lstm_classify/weight/lstmclassify_layer1_perpect.pt")
...
def train(train_data,train_label):
    ...
    torch.save(seq, "/home/iichsk/workspace/vrep_lstm_classify/weight/lstmclassify_{}.pt".format(count_t))
    return output
...
def test(test_data, test_label):
    ...
    for ii in range(int(test_data.shape[1]/bsz)):
        for i in range(1):
            ...
            print('1 input testing time = ', test_time)
...
def main():
############### load dataset ######################
    path1 = '/home/iichsk/workspace/vrep_lstm_classify/database/vrep_joint2_normal_1seq2.csv'
    dataX1, data_label_Y1 = lp.load_data(path1, seq_len)
    path2 = '/home/iichsk/workspace/vrep_lstm_classify/database/vrep_joint1_bsf_01_1seq2.csv'
    dataX2, data_label_Y2 = lp.load_data2(path2, seq_len)
    path3 = '/home/iichsk/workspace/vrep_lstm_classify/database/vrep_joint2_error_03_1seq2.csv'
    dataX3, data_label_Y3 = lp.load_data(path3, seq_len)
    dataX = np.concatenate((dataX1,dataX2,dataX3), axis=0)
    data_label_Y = np.concatenate((data_label_Y1, data_label_Y2, data_label_Y3), axis=0)
