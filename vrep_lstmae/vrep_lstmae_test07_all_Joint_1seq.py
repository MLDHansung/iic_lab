...
def checkpoint2():
    ...
    io.savemat(
        ...
        'joint1errortarget': target3_error, 'joint2errortarget': target4_error,
...
'''path = '/home/iichsk/workspace/dataset/vrep_dataset/vrep_joint1_normal_1seq.csv'
trainX_tmp1, testX_tmp1=lap.load_data(path, seq_len)'''

path = '/home/iichsk/workspace/dataset/vrep_dataset/vrep_joint2_normal_1seq.csv'
trainX_tmp2, testX_tmp2=lap.load_data(path, seq_len)

#trainX = np.concatenate((trainX_tmp2,trainX_tmp1),axis=1)
...
print('testX_tmp1',testX_tmp1.shape)
test_bsz=1
...
print('testX_tmp2',testX_tmp2.shape)
...
test_bsz=1
path2='/home/iichsk/workspace/dataset/vrep_dataset/vrep_joint1_bsf_01_1seq.csv'
_, error_joint1_testX=lap.load_data(path2, seq_len)
print('error_joint1_testX',error_joint1_testX.shape)
...
predict3_error, target3_error = lap.normalize_inverse(predict3, error_joint1_testX)

print('start joint2 error test....')
test_bsz=1
path2='/home/iichsk/workspace/dataset/vrep_dataset/vrep_joint2_error_03_1seq.csv'
_, error_joint2_testX=lap.load_data(path2, seq_len)
print('error_joint2_testX',error_joint2_testX.shape)
...
predict4_error, target4_error = lap.normalize_inverse(predict4, error_joint2_testX)
