...
seq = torch.load("/home/iichsk/workspace/vrep_lstmae/weight/lstmclassify_perpect2.pt")
...
def train(train_data,train_label):
    ...
    torch.save(seq, "/home/iichsk/workspace/vrep_lstmae/weight/lstmclassify_{}.pt".format(count_t))
    return output
...
def main():
############### load dataset ######################
    path1 = '/home/iichsk/workspace/dataset/vrep_dataset/vrep_joint2_normal_1seq2.csv'
    dataX1, data_label_Y1 = lp.load_data(path1, seq_len)
    path2 = '/home/iichsk/workspace/dataset/vrep_dataset/vrep_joint1_bsf_01_1seq2.csv'
    dataX2, data_label_Y2 = lp.load_data2(path2, seq_len)
    path3 = '/home/iichsk/workspace/dataset/vrep_dataset/vrep_joint2_error_03_1seq2.csv'
