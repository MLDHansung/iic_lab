...
test_set = train_test_dataset.iloc[:, :]
...
train_label_set2 = label_set2[0:16800]
test_label_set2 = label_set2[16800:]
training_set2 = train_test_dataset2.iloc[0:16800, :]
test_set2 = train_test_dataset2.iloc[16800:, :]
...
train_label_set3 = label_set3[0:5000]
test_label_set3 = label_set3[5000:]
training_set3 = train_test_dataset3.iloc[0:5000, :]
test_set3 = train_test_dataset3.iloc[5000:, :]
...
#concatenate data
trainX = np.concatenate((trainX,trainX2,trainX3), axis=1)
...
print('train_label_Y2',train_label_Y2.shape)
print('train_label_Y3',train_label_Y3.shape)
train_label_Y1 = train_label_Y[:531, :]
train_label_Y2 = train_label_Y[531:1779, :]
train_label_Y3 = train_label_Y[1779:, :]
print('train_label_Y1',train_label_Y1.shape)
print('train_label_Y2',train_label_Y2.shape)
print('train_label_Y3',train_label_Y3.shape)

testX = np.concatenate((testX,testX2,testX3), axis=1)
test_label_Y = np.concatenate((test_label_Y, test_label_Y2, test_label_Y3), axis=0)
