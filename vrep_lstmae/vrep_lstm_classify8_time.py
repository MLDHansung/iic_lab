...
'''for i in range(300,17400):
    if i%300==0:
        a=i
        #print(a)
        print('a',a)
        train_label_set2.append(label_set2.iloc[a+1:a+25])

        training_set2.append(train_test_dataset2.iloc[a+1:a+25,:])'''



training_set2 = sc.fit_transform(training_set2)
training_set2_temp = np.zeros(((1450,8)))
