...
count_t = time.time()
torch.save(net, "/home/iichsk/workspace/weight/siamese_weight{}.pt".format(count_t))
...
for z, data in enumerate(test_dataloader,0):
    x0,_,_ = data
    ...
    for i, data in enumerate(test_dataloader,0):
        ...
        imshow(torchvision.utils.make_grid(concatenated),'test_result/test_{}_{}'.format(z,i),'Dissimilarity: {:.2f}'.format(euclidean_distance.item()))
