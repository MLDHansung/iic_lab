...
def show_plot(iteration,loss,name):
    ...
    plt.close()
class Config():
    training_dir = "/home/iichsk/workspace/dataset/facedatabase/wav_sym/training/"
    testing_dir = "/home/iichsk/workspace/dataset/facedatabase/wav_sym/testing/"
    train_batch_size = 64
...
for i, data in enumerate(test_dataloader,0):
    ...
    imshow(torchvision.utils.make_grid(concatenated),'waveform_sym_test_result2/test_{}'.format(i),'Dissimilarity: {:.2f}'.format(euclidean_distance.item()),fname0,fname1,'label={}'.format(label2))
