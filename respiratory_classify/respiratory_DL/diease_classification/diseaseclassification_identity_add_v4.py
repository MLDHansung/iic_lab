...
class ensemble_cnn(nn.Module):
    ...
    def __init__(self):
        ...
        self.ensemble_fc1 = nn.Linear(128, classes)
...
ensemble_cnn.load_state_dict(torch.load("/home/iichsk/workspace/weight/ensemble_cnn/ensemble_cnn_weight_450_128_1634198453.7271717.pt"))
