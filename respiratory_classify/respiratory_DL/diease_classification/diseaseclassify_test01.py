...
# np.save('/home/iichsk/workspace/respiratory_classify/numpy_dataset/trainset/mfcc_trainset_{}.npy'.format(count_t),spt_train)
# np.save('/home/iichsk/workspace/respiratory_classify/numpy_dataset/testset/mfcc_testset_{}.npy'.format(count_t),spt_test)

# np.save('/home/iichsk/workspace/respiratory_classify/numpy_dataset/trainset/waveform_trainset_{}.npy'.format(count_t),img_train)
# np.save('/home/iichsk/workspace/respiratory_classify/numpy_dataset/testset/waveform_testset_{}.npy'.format(count_t),img_test)

# np.save('/home/iichsk/workspace/respiratory_classify/numpy_dataset/trainset/train_label_{}.npy'.format(count_t),label_train)
# np.save('/home/iichsk/workspace/respiratory_classify/numpy_dataset/testset/test_label_{}.npy'.format(count_t),label_test)
...
spt_train = np.load('/home/iichsk/workspace/respiratory_classify/numpy_dataset/trainset/mfcc_trainset_1634637424.9790626.npy')
spt_test = np.load('/home/iichsk/workspace/respiratory_classify/numpy_dataset/testset/mfcc_testset_1634637424.9790626.npy')

img_train = np.load('/home/iichsk/workspace/respiratory_classify/numpy_dataset/trainset/waveform_trainset_1634637424.9790626.npy')
img_test = np.load('/home/iichsk/workspace/respiratory_classify/numpy_dataset/testset/waveform_testset_1634637424.9790626.npy')

label_train = np.load('/home/iichsk/workspace/respiratory_classify/numpy_dataset/trainset/train_label_1634637424.9790626.npy')
label_test = np.load('/home/iichsk/workspace/respiratory_classify/numpy_dataset/testset/test_label_1634637424.9790626.npy')
...
# make_dot(concat_fc(spt_input), params=dict(concat_fc.named_parameters())).render("graph", format="png")
