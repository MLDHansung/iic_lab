...
count_t = time.time()
np.save('/home/iichsk/workspace/respiratory_classify/numpy_dataset/trainset/mfcc_trainset_{}.npy'.format(count_t),mfcc_trainset)
np.save('/home/iichsk/workspace/respiratory_classify/numpy_dataset/testset/mfcc_testset_{}.npy'.format(count_t),mfcc_testset)

np.save('/home/iichsk/workspace/respiratory_classify/numpy_dataset/trainset/waveform_trainset_{}.npy'.format(count_t),waveform_trainset)
np.save('/home/iichsk/workspace/respiratory_classify/numpy_dataset/testset/waveform_testset_{}.npy'.format(count_t),waveform_testset)

np.save('/home/iichsk/workspace/respiratory_classify/numpy_dataset/trainset/train_label_{}.npy'.format(count_t),train_label)
np.save('/home/iichsk/workspace/respiratory_classify/numpy_dataset/testset/test_label_{}.npy'.format(count_t),test_label)
...
class ensemble_cnn(nn.Module):
    ...
    def __init__(self):
        ...
        self.spt_bn1 = torch.nn.BatchNorm2d(16)
        ...
        self.spt_bn2 = torch.nn.BatchNorm2d(32)
        ...
        self.spt_bn3 = torch.nn.BatchNorm2d(64)
        ...
        self.img_bn1 = torch.nn.BatchNorm2d(16)

        self.img_conv2 = nn.Conv2d(16, 32, kernel_size=5)  # 32@18*429
        self.img_pool2 = nn.MaxPool2d(2)  # 32@9*214
        self.img_dropout2 = nn.Dropout(img_dropout)
        self.img_bn2 = torch.nn.BatchNorm2d(32)
    
        self.img_conv3 = nn.Conv2d(32, 64, kernel_size=(2,5))  # 64@8*213
        self.img_pool3 = nn.MaxPool2d(2)  # 64@4*106
        self.img_dropout3 = nn.Dropout(img_dropout)
        self.img_bn3 = torch.nn.BatchNorm2d(64)
        ...
        self.img_bn4 = torch.nn.BatchNorm2d(128)
...
ensemble_cnn.load_state_dict(torch.load("/home/iichsk/workspace/weight/ensemble_cnn/ensemble_cnn_weight_450_128_1634201123.1305344.pt"))
...
# mfcc_trainset = np.load('/home/iichsk/workspace/respiratory_classify/numpy_dataset/trainset/mfcc_trainset_1634191881.6733181.npy')
# mfcc_testset = np.load('/home/iichsk/workspace/respiratory_classify/numpy_dataset/testset/mfcc_testset_1634191881.6733181.npy')

# waveform_trainset = np.load('/home/iichsk/workspace/respiratory_classify/numpy_dataset/trainset/waveform_trainset_1634191881.6733181.npy')
# waveform_testset = np.load('/home/iichsk/workspace/respiratory_classify/numpy_dataset/testset/waveform_testset_1634191881.6733181.npy')

# train_label = np.load('/home/iichsk/workspace/respiratory_classify/numpy_dataset/trainset/train_label_1634191881.6733181.npy')
# test_label = np.load('/home/iichsk/workspace/respiratory_classify/numpy_dataset/testset/test_label_1634191881.6733181.npy')
