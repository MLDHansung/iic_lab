...
def concat_test(concat_testset):
    ...
    concat_features = np.zeros((int(concat_testset.shape[0]), 128))
...
df5 = pd.DataFrame(img_feature)
count_t = time.time()
df5.to_excel("/home/iichsk/workspace/wavpreprocess/pre_img_feature_{}.xlsx".format(count_t), sheet_name = 'sheet1')
