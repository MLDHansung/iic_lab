...
mfcc_dataset = np.load('mfcc_crackle_d.npy')
dataset_label = np.load('dataset_label_crackle_d.npy')
...
# np.save('mfcc_crackle_d_testset.npy')
# np.save('dataset_label_crackle_d_testset.npy')
...
c_names = ['crackles_Bronchiectasis','crackles_Bronchiolitis','crackles_COPD',
'crackles_Pneumonia','crackles_URTI','crackles_zHealthy']
