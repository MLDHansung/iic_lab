...
mfcc_trainset = np.load('mfcc_trainset.npy')
mfcc_testset = np.load('mfcc_testset.npy')
...
c_names = ['h_normal','d_normal','wheezes','crackles','Both']
...
# MFCC feature t-sne
print(target.shape)
print(MFCC_predictions.shape)
print(MFCC_predictions_arg.shape)
