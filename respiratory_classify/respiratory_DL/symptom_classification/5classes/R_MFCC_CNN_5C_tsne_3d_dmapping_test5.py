...
mfcc_testset = np.load('mfcc_testset_all.npy')
test_label = np.load('test_label_all.npy')
print('testlabel.shape = ',test_label.shape)
...
MFCC_cnn.load_state_dict(torch.load("/home/iichsk/workspace/weight/MFCC_cnn2_normal_weight_200_512_8class.pt"))
...
#         c=plt.cm.Set1(np.argmax(test_label, axis=1)))
group = target
# cdict = {0:'red',1:'blue',2:'yellow',3:'coral',4:'honeydew',5:'black',6:'sienna',7:'pink',8:'gray',9:'purple',10:'olive',11:'lime',12:'lightskyblue',13:'cyan',14:'orange'}
cdict = {0:'red',1:'blue',2:'yellow',3:'purple',4:'lightskyblue',5:'black',6:'green',7:'orange'}

# labeldict= {0:'h_normal_zHealthy',1:'d_normal_Asthma',2:'d_normal_Bronchiectasis',3:'d_normal_Bronchiolitis',4:'d_normal_COPD',5:'d_normal_LRTI',
# 6:'d_normal_Pneumonia',7:'d_normal_URTI',8:'mix_Bronchiectasis',9:'mix_Bronchiolitis',10:'mix_COPD',11:'mix_LRTI',
# 12:'mix_Pneumonia',13:'mix_URTI',14:'mix_zHealthy'}
labeldict= {0:'h_normal_Healthy',1:'d_normal_Asthma',2:'d_normal_Bronchiectasis',3:'d_normal_Bronchiolitis',4:'d_normal_COPD',5:'d_normal_LRTI',
6:'d_normal_Pneumonia',7:'d_normal_URTI'}
for g in np.unique(group):
    i=np.where(group == g)
    ax.scatter(embedded[i,0],embedded[i,1],embedded[i,2],c=cdict[g],label=labeldict[g],s=0.7)
ax.legend(bbox_to_anchor=(1.05, 1.0), loc='upper left')
for x in range(0,361,10):
    for y in range(0,361,10):
        ax.view_init(x,y)
        plt.savefig('/home/iichsk/workspace/respiratory_classify/respiratory_DL/symptom_classification/5classes/T-SNE_3D_image_test2_8class/MFCC_feature_T_sne_{}_{}.png'.format(x,y),bbox_inches='tight')
# def animate(i):
