...
mfcc_dataset = np.load('mfcc_wheeze_d.npy')
dataset_label = np.load('dataset_label_wheeze_d.npy')
...
c_names = ['wheezes_Bronchiectasis','wheezes_Bronchiolitis',
'wheezes_COPD','wheezes_Pneumonia','wheezes_URTI']
