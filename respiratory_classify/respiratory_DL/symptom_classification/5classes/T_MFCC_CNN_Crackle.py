...
mfcc_testset = np.load('mfcc_crackle_d.npy')
test_label = np.load('dataset_label_crackle_d.npy')
...
MFCC_cnn.load_state_dict(torch.load("/home/iichsk/workspace/weight/MFCC_crackle_200.pt"))
...
group = target
cdict = {0:'red',1:'blue',2:'purple',3:'orange',4:'lightskyblue',5:'black'}
mdict = {0:'o',1:'v',2:'x',3:'^',4:'*',5:'s'}

labeldict= {0:'crackles_Bronchiectasis',1:'crackles_Bronchiolitis',2:'crackles_COPD',3:'crackles_Pneumonia',4:'crackles_URTI',5:'crackles_Healthy'}
...
for x in range(0,361,10):
    for y in range(0,361,10):
        ax.view_init(x,y)
        plt.savefig('/home/iichsk/workspace/respiratory_classify/respiratory_DL/symptom_classification/5classes/T-SNE_3D_image_crackle/MFCC_feature_T_sne_{}_{}.png'.format(x,y),bbox_inches='tight')
