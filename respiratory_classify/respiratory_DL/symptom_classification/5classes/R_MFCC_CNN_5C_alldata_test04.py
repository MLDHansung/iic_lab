...
# np.save('mfcc_trainset_5classes.npy',mfcc_trainset)
# np.save('mfcc_testset_5classes.npy',mfcc_testset)
# np.save('train_label_5classes.npy',train_label)
# np.save('test_label_5classes.npy',test_label)
mfcc_trainset = np.load('mfcc_trainset_5classes.npy')
mfcc_testset = np.load('mfcc_testset_5classes.npy')
train_label = np.load('train_label_5classes.npy')
test_label = np.load('test_label_5classes.npy')
...
# MFCC_cnn.load_state_dict(torch.load("/home/iichsk/workspace/weight/MFCC_cnn2_weight_100_512_1638697462.2195199.pt"))
...
# MFCC CNN part
mfcc_dataset=np.concatenate((mfcc_trainset,mfcc_testset),0)
dataset_label=np.concatenate((train_label,test_label),0)

MFCC_train(mfcc_dataset, dataset_label)
