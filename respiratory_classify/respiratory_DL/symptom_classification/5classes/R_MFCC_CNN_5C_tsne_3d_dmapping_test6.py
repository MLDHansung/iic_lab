...
mfcc_testset = np.load('mfcc_dataset_9classes.npy')
test_label = np.load('dataset_label_9classes.npy')
...
cdict = {0:'red',1:'blue',2:'yellow',3:'purple',4:'lightskyblue',5:'black',6:'green',7:'orange',8:'gray'}
...
labeldict= {0:'h_normal_Healthy',1:'d_normal_Bronchiectasis',2:'d_normal_Bronchiolitis',3:'d_normal_COPD',4:'d_normal_Pneumonia',5:'d_normal_URTI',
6:'wheezes',7:'xcrackles',8:'Crackle+Wheeze'}
...
for x in range(0,361,10):
    for y in range(0,361,10):
        ax.view_init(x,y)
        plt.savefig('/home/iichsk/workspace/respiratory_classify/respiratory_DL/symptom_classification/5classes/T-SNE_3D_image_test2_9class/MFCC_feature_T_sne_{}_{}.png'.format(x,y),bbox_inches='tight')
# def animate(i):
