...
np.save('mfcc_trainset.npy',mfcc_trainset)
np.save('mfcc_testset.npy',mfcc_testset)
...
# MFCC_cnn.load_state_dict(torch.load("/home/iichsk/workspace/weight/MFCC_cnn_weight_300_128_1631519791.0948753.pt"))
