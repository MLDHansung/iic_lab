...
mfcc_dataset = np.load('mfcc_normal_d.npy')
dataset_label = np.load('dataset_label_normal_d.npy')
...
c_names = ['normal_Bronchiectasis','normal_Bronchiolitis','normal_COPD',
'normal_Pneumonia','normal_URTI','normal_Healthy']
