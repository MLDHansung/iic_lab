...
mfcc_testset = np.load('mfcc_both_d.npy')
test_label = np.load('dataset_label_both_d.npy')
...
MFCC_cnn.load_state_dict(torch.load("/home/iichsk/workspace/weight/MFCC_both_200.pt"))
...
labeldict= {0:'Both_Bronchiectasis',1:'Both_Bronchiolitis',2:'Both_COPD'}
mdict = {0:'o',1:'v',2:'x'}
...
for x in range(0,361,10):
    for y in range(0,361,10):
        ax.view_init(x,y)
        plt.savefig('/home/iichsk/workspace/respiratory_classify/respiratory_DL/symptom_classification/5classes/T-SNE_3D_image_both/MFCC_feature_T_sne_{}_{}.png'.format(x,y),bbox_inches='tight')
