...
MFCC_cnn.load_state_dict(torch.load("/home/iichsk/workspace/weight/MFCC_cnn2_normal_weight_200_512_80train.pt"))
...
for x in range(0,361,10):
    for y in range(0,361,10):
        ax.view_init(x,y)
        plt.savefig('/home/iichsk/workspace/respiratory_classify/respiratory_DL/symptom_classification/5classes/T-SNE_3D_image_test2_80/MFCC_feature_T_sne_{}_{}.png'.format(x,y),bbox_inches='tight')
# def animate(i):
