...
scalogram_trainset = np.load('scalo_trainset_5classes.npy')
scalogram_testset = np.load('scalo_testset_5classes.npy')
...
MFCC_cnn.load_state_dict(torch.load("/home/iichsk/workspace/weight/MFCC_cnn2_weight_300_128_64.pt"),strict=False)

scalo_cnn = scalo_cnn()
scalo_cnn.cuda()
scalo_optimizer = optim.Adam(scalo_cnn.parameters(), lr=learning_rate)
scalo_cnn.load_state_dict(torch.load("/home/iichsk/workspace/weight/Scalogram_cnn_weight_200_128_62.pt"),strict=False)
