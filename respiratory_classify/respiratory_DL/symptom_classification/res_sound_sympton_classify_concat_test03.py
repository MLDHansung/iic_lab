...
spt_dropout = 0.3
img_dropout = 0.3
mypath = "/home/iichsk/workspace/dataset/Respiratory_Sound_Database/Respiratory_Sound_Database/processed_audio_files2"
mypath2 = "/home/iichsk/workspace/dataset/Respiratory_Sound_Database/Respiratory_Sound_Database/processed_audio_files2"
...
class spt_cnn(nn.Module):
    ...
    def __init__(self):
        ...
        self.spt_conv1 = nn.Conv2d(1, 16, kernel_size=10)  # 16@39*861
        ...
        self.spt_conv3 = nn.Conv2d(32, 64, kernel_size=filter_size2)  # 64@8*213
        self.spt_pool3 = nn.MaxPool2d(2)  # 64@4*106
        self.spt_dropout3 = nn.Dropout(spt_dropout)
        self.spt_conv4 = nn.Conv2d(64, 128, kernel_size=filter_size2)  # 128@3*105
        ...
        self.spt_fcdropout1 = nn.Dropout(spt_dropout)
...
spt_cnn = spt_cnn()
spt_cnn.cuda()
spt_cnn.load_state_dict(torch.load("/home/iichsk/workspace/weight/symptom_spt_cnn_weight_4_2000_128_1617773893.6412332.pt"))
...
class cnn(nn.Module):
    ...
    def __init__(self):
        ...
        self.img_conv4 = nn.Conv2d(64, 128, kernel_size=filter_size4)  # 128@3*105
        self.img_pool4 = nn.MaxPool2d(2)  # 128@1*52
        self.img_dropout4 = nn.Dropout(img_dropout)
        self.img_conv5 = nn.Conv2d(128, 256, kernel_size=filter_size4)  # 128@3*105
        self.img_pool5 = nn.MaxPool2d(2)  # 128@1*52
        self.img_dropout5 = nn.Dropout(img_dropout)
        self.img_conv6 = nn.Conv2d(256, 512, kernel_size=filter_size4)  # 128@3*105
        self.img_pool6 = nn.MaxPool2d(2)  # 128@1*52
        self.img_dropout6 = nn.Dropout(img_dropout)
        self.img_conv7 = nn.Conv2d(512, 1024, kernel_size=2)  # 128@3*105
        self.img_pool7 = nn.MaxPool2d(2)  # 128@1*52
        ...
        self.img_bn2 = torch.nn.BatchNorm1d(256)

        self.img_fc3 = nn.Linear(256, 128)
        self.img_bn3 = torch.nn.BatchNorm1d(128)

        self.img_fc4 = nn.Linear(128, 64)
        self.img_bn4 = torch.nn.BatchNorm1d(64)

        self.img_fc5 = nn.Linear(64, classes)
    ...
    def forward(self, img_x):
        ...
        img_x = self.img_fc4(img_x)
        img_x = self.img_bn4(img_x)
        img_feature_x=img_x

        img_x = self.img_fc5(img_x)

        return img_x, img_feature_x
# hyper-parameters
img_cnn = cnn()
img_cnn.cuda()
img_cnn.load_state_dict(torch.load("/home/iichsk/workspace/weight/sym_concat/symptom_wav_cnn_weight_4_500_128_1617604076.8674874.pt"))
...
class concat_fc(nn.Module):
    def __init__(self):
        ...
        self.concat_fc1 = nn.Linear(192, 64)
        self.concat_fc2 = nn.Linear(64, 32)
        self.concat_fc3 = nn.Linear(32, classes)


        self.concat_relu = nn.ReLU()
        self.concat_bn1 = torch.nn.BatchNorm1d(64)
        self.concat_bn2 = torch.nn.BatchNorm1d(32)
...
concat_fc.load_state_dict(torch.load("/home/iichsk/workspace/respiratory_classify/respiratory_DL/weight/concat_fc_weight_350_128_1628489575.8587527.pt"))
...
def spt_cnn_test(spt_data):
    ...
    spt_feature = np.zeros((int(spt_data.shape[0]), 128))
    correct = 0
    wrong = 0
...
def img_cnn_test(img_data):
    ...
    img_feature = np.zeros((int(img_data.shape[0]), 64))
...
df = pd.DataFrame(concat_pred,columns=['ensem','target'])
print(df)
count_t = time.time()
