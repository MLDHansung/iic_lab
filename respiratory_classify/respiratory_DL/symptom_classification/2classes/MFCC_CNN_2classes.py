...
# p_diag = pd.read_csv("/home/iichsk/workspace/dataset/Respiratory_Sound_Database/Respiratory_Sound_Database/csv_data/2classes_label.csv",header=None) # patient diagnosis csv file
...
# trainset_p_id_pd =pd.DataFrame(trainset_p_id)
# trainset_p_id_pd.to_csv("trainset_p_id_pd.csv")
# testset_p_id_pd =pd.DataFrame(testset_p_id)
# testset_p_id_pd.to_csv("testset_p_id_pd.csv")
...
# np.save('mfcc_trainset_2class.npy', mfcc_trainset)
# np.save('mfcc_testset_2class.npy', mfcc_testset)
# np.save('train_label_2class.npy', train_label)
# np.save('test_label_2class.npy', test_label)
