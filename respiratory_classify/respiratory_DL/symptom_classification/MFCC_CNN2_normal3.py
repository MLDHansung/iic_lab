...
mfcc_dataset = np.load('mfcc_testset_all.npy')
dataset_label = np.load('test_label_all.npy')
...
c_names = ['h_normal','d_normal_Bronchiectasis',
'd_normal_Bronchiolitis','d_normal_COPD','d_normal_LRTI',
'd_normal_Pneumonia','d_normal_URTI']
