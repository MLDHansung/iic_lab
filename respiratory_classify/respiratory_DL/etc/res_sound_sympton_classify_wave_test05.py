...
img_dropout = 0.35
classes = 4
mypath = "/home/iichsk/workspace/dataset/Respiratory_Sound_Database/Respiratory_Sound_Database/processed_audio_files_nopad_waveform/"
...
class cnn(nn.Module):
    ...
    def __init__(self):
        ...
        self.img_conv1 = nn.Conv2d(1, 32, kernel_size=filter_size3)  # 16@39*861
        self.img_pool1 = nn.MaxPool2d(3)  # 16@19*430
        self.img_dropout1 = nn.Dropout(img_dropout)
        self.img_conv2 = nn.Conv2d(32, 64, kernel_size=filter_size4)  # 32@18*429
        self.img_pool2 = nn.MaxPool2d(3)  # 32@9*214
        self.img_dropout2 = nn.Dropout(img_dropout)
        self.img_conv3 = nn.Conv2d(64, 128, kernel_size=filter_size4)  # 64@8*213
        self.img_pool3 = nn.MaxPool2d(3)  # 64@4*106
        self.img_dropout3 = nn.Dropout(img_dropout)
        self.img_conv4 = nn.Conv2d(128, 256, kernel_size=filter_size4)  # 128@3*105
        self.img_pool4 = nn.MaxPool2d(2)  # 128@1*52
        self.img_dropout4 = nn.Dropout(img_dropout)
        self.img_conv5 = nn.Conv2d(256, 512, kernel_size=filter_size4)  # 128@3*105
        self.img_pool5 = nn.MaxPool2d(2)  # 128@1*52
        self.img_dropout5 = nn.Dropout(img_dropout)
        '''self.img_conv6 = nn.Conv2d(512, 1024, kernel_size=filter_size4)  # 128@3*105
                                self.img_pool6 = nn.MaxPool2d(3)  # 128@1*52
