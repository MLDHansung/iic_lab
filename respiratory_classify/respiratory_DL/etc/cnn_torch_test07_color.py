...
dropout = 0.3
filter_size = 4
mypath = "/home/iichsk/workspace/dataset/spectrum_figure4/audio_and_txt_files2"
#mypath2 = "/home/iichsk/workspace/dataset/spectrum_figure4/audio_and_txt_files2"
...
def extract_image(file_name):
    im = cv2.imread(file_name, cv2.IMREAD_COLOR) # 861x200x3
    return im
...
class cnn(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 16, kernel_size=filter_size)  # 16@39*861
        self.pool1 = nn.MaxPool2d(2)  # 16@19*430
        self.dropout1 = nn.Dropout(dropout)
        self.conv2 = nn.Conv2d(16, 32, kernel_size=filter_size)  # 32@18*429
        self.pool2 = nn.MaxPool2d(2)  # 32@9*214
        self.dropout2 = nn.Dropout(dropout)
        self.conv3 = nn.Conv2d(32, 64, kernel_size=filter_size)  # 64@8*213
        self.pool3 = nn.MaxPool2d(2)  # 64@4*106
        self.dropout3 = nn.Dropout(dropout)
        self.conv4 = nn.Conv2d(64, 128, kernel_size=filter_size)  # 128@3*105
        self.pool4 = nn.MaxPool2d(2)  # 128@1*52
        self.dropout4 = nn.Dropout(dropout)
        self.conv5 = nn.Conv2d(128, 256, kernel_size=filter_size)  # 128@3*105
        self.pool5 = nn.MaxPool2d(2)  # 128@1*52
        self.dropout5 = nn.Dropout(dropout)
        self.conv6 = nn.Conv2d(256, 512, kernel_size=filter_size)  # 128@3*105
        self.pool6 = nn.MaxPool2d(2)  # 128@1*52
