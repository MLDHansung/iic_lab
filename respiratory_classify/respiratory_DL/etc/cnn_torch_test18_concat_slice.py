...
classes = 6
dropout = 0.325
mypath = "/home/iichsk/workspace/dataset/sliced_respiratory_database/output_loc"
mypath2 = "/home/iichsk/workspace/dataset/sliced_respiratory_database/output_loc"
...
spt_cnn = spt_cnn()
spt_cnn.cuda()
spt_cnn.load_state_dict(torch.load("/home/iichsk/workspace/weight/slice_spt_cnn_weight_6_4000_128_test01.pt"))
...
class img_cnn(nn.Module):
    ...
    def __init__(self):
        ...
        self.img_conv6 = nn.Conv2d(256, 512, kernel_size=filter_size2)  # 128@3*105
        self.img_pool6 = nn.MaxPool2d(2)  # 128@1*52
        self.img_dropout6 = nn.Dropout(dropout)
        ...
        self.img_bn2 = torch.nn.BatchNorm1d(128)
        self.img_fc3 = nn.Linear(128, 64)
        self.img_bn3 = torch.nn.BatchNorm1d(64)
        self.img_fc4 = nn.Linear(64, classes)
...
img_cnn = img_cnn()
img_cnn.cuda()
img_cnn.load_state_dict(torch.load("/home/iichsk/workspace/weight/slice_img_cnn_weight_6_1000_128_test01.pt"))
...
class concat_fc(nn.Module):
    def __init__(self):
        ...
        self.concat_fc1 = nn.Linear(768, 512)
        self.concat_fc2 = nn.Linear(512, 256)
        self.concat_fc3 = nn.Linear(256, 128)
        self.concat_fc4 = nn.Linear(128, classes)

        self.concat_relu = nn.ReLU()
        self.concat_bn1 = torch.nn.BatchNorm1d(512)
        self.concat_bn2 = torch.nn.BatchNorm1d(256)
        self.concat_bn3 = torch.nn.BatchNorm1d(128)


        self.concat_dropout1 = nn.Dropout(0.3)
        self.concat_dropout2 = nn.Dropout(0.3)
        self.concat_dropout3 = nn.Dropout(0.3)
    ...
    def forward(self, concat_x):
        ...
        concat_x = self.concat_bn3(concat_x)
        concat_x = self.concat_dropout3(concat_x)
        concat_x = self.concat_fc4(concat_x)  #   
...
def spt_cnn_test(spt_data):
    ...
    spt_feature = np.zeros((int(spt_data.shape[0]), 256, 1,1))
...
def img_cnn_test(img_data):
    ...
    img_feature = np.zeros((int(img_data.shape[0]), 512, 1,1))
