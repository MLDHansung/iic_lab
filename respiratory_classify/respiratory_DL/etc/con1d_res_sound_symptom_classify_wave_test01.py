...
dropout = 0.3
classes = 4
mypath = "/home/iichsk/workspace/dataset/Respiratory_Sound_Database/Respiratory_Sound_Database/processed_audio_files/"
...
class spt_cnn(nn.Module):
    ...
    def __init__(self):
        ...
        self.spt_fc1 = nn.Linear(32, 16)
        self.spt_bn1 = torch.nn.BatchNorm1d(16)
        self.spt_fcdropout1 = nn.Dropout(dropout)

        self.spt_fc2 = nn.Linear(16, classes) 
