...
spt_features1 = np.delete(spt_features, np.where((labels == 'Asthma') | (labels == 'LRTI') | (labels == 'Healthy'))[0], axis=0)
labels1 = np.delete(labels, np.where((labels == 'Asthma') | (labels == 'LRTI') | (labels == 'Healthy'))[0], axis=0)

img_features = np.array(img_features)
#print('img_features', img_features.shape)
img_features1 = np.delete(img_features, np.where((labels2 == 'Asthma') | (labels2 == 'LRTI') | (labels2 == 'Healthy'))[0], axis=0)
img_labels1 = np.delete(labels2, np.where((labels2 == 'Asthma') | (labels2 == 'LRTI') | (labels2 == 'Healthy'))[0], axis=0)
...
class cnn(nn.Module):
    ...
    def __init__(self):
        ...
        self.img_fc2 = nn.Linear(256, classes)
...
def train():
    ...
    torch.save(cnn.state_dict(), "/home/iichsk/workspace/weight/img_cnn_weight_{}_{}_{}_{}.pt".format(classes, num_epochs, batch_size, count_t))
...
c_names = ['Bronchiectasis', 'Bronchiolitis', 'COPD', 'Pneumonia', 'URTI']
