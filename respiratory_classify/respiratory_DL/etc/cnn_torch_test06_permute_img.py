...
spt_features1 = np.delete(spt_features, np.where((labels2 == 'Asthma') | (labels2 == 'LRTI'))[0], axis=0)
...
def train():
    ...
    torch.save(cnn.state_dict(), "/home/iichsk/workspace/weight/img_cnn_weight_{}_{}_{}.pt".format(num_epochs, batch_size, count_t))
